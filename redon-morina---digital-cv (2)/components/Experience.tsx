...
export const Experience: React.FC<ExperienceProps> = ({ data }) => {
  ...
  return (
    <section className="py-20 md:py-24 px-6 md:px-12 bg-white relative z-20">
      
      <div className="max-w-[80rem] mx-auto">
        <Section className="mb-12 md:mb-16 border-b border-stone-900 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
             <h2 
               className="font-display font-black text-3xl md:text-6xl uppercase leading-[0.9] tracking-tighter text-stone-900 hyphens-auto w-full md:w-auto"
               lang={lang}
             >
             ...
             <span className="font-mono text-xs text-stone-500 shrink-0">[ 2021 — 2025 ]</span>
        </Section>
        ...
        <div className="flex flex-col">
          {data.experience.map((job, index) => (
            <Section key={index} delay={index * 50}>
              <div 
                className="group relative border-b border-stone-200 hover:border-stone-900 transition-colors duration-500 py-8 md:py-10 cursor-pointer"
              >
                <div className="flex flex-col md:flex-row md:items-baseline justify-between relative z-10 text-stone-900 md:group-hover:text-stone-400 transition-colors">
                    ...
                    <div className="md:w-2/4">
                        <h3 className="font-display font-black text-2xl sm:text-3xl md:text-4xl uppercase mb-1 leading-[0.9] tracking-tight md:group-hover:translate-x-4 transition-transform duration-500 ease-out text-stone-900 md:group-hover:text-accent-blue break-words hyphens-auto">
                            {job.company}
                        </h3>
